...
public class StructureCheckv1_21_R2 extends StructureCheck {
    public StructureCheckv1_21_R2(Map<String, Boolean> structureMap) {
        super(structureMap);
    }
    ...
    public List<Condition> parse(ConfigurationNode configurationNode) {
        ...
        conditionList.add(new StructureCheckv1_21_R2(result));
    ...
    private org.bukkit.generator.structure.Structure getStructureType(String structureType) {
        return switch (structureType.toUpperCase()) {
            ...
            case "TRIAL_CHAMBERS" -> org.bukkit.generator.structure.Structure.TRIAL_CHAMBERS;
            default -> {
