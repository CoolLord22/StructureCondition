...
public class StructureCheckv1_21_R1 extends StructureCheck {
    public StructureCheckv1_21_R1(Map<String, Boolean> structureMap) {
        super(structureMap);
    }
    ...
    public List<Condition> parse(ConfigurationNode configurationNode) {
        ...
        conditionList.add(new StructureCheckv1_21_R1(result));
