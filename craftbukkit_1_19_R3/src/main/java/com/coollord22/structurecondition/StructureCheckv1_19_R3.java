...
public class StructureCheckv1_19_R3 extends StructureCheck {
    public StructureCheckv1_19_R3(Map<String, Boolean> structureMap) {
        super(structureMap);
    }
            ...
            for(Map.Entry<String, Boolean> entry : structureMap.entrySet()) {
                if(getStructureType(entry.getKey()) != null) {
                    ...
                    if(searchResult != null) {
                        IChunkAccess craftChunk = ((CraftChunk) searchResult.getLocation().getChunk()).getHandle(ChunkStatus.o);
    ...
    public List<Condition> parse(ConfigurationNode configurationNode) {
        ...
        conditionList.add(new StructureCheckv1_19_R3(result));
