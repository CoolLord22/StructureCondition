...
public class StructureCheckv1_20_R3 extends StructureCheck {
    public StructureCheckv1_20_R3(Map<String, Boolean> structureMap) {
        super(structureMap);
    }
    ...
    public List<Condition> parse(ConfigurationNode configurationNode) {
        ...
        conditionList.add(new StructureCheckv1_20_R3(result));
